...
while (cap.isOpened()):
    ...
    if ret == True:
        ...
        # CREATING MASK RANGE
        mask = cv.inRange(hsv_frame, (39, 31, 94), (82, 255, 255))  # 31,136,59  126,255,255
        ...
        for cnt in contours:
            ...
            if w > 40 and h > 40:
                ...
                circles = cv.HoughCircles(hough, cv.HOUGH_GRADIENT, 1, 200, param1=30, param2=35, minRadius=15, maxRadius=150)
