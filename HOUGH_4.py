...
while (cap.isOpened()):
    ...
    if ret == True:
        ...
        # CREATING MASK RANGE
        mask = cv.inRange(hsv_frame, (36, 40, 62), (62, 255, 255))  # 31,136,59  126,255,255
        ...
        for cnt in contours:
            ...
            if w > 45 and h > 45 and asp_ratio<1.2 and asp_ratio >0.8 and w<150 and h<150:
                ...
                circles = cv.HoughCircles(hough, cv.HOUGH_GRADIENT, 1, 200, param1=35, param2=35, minRadius=20, maxRadius=150)
